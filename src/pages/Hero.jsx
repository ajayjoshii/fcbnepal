...
//   return (
//     <>
//       <section className=" min-h-screen flex items-center overflow-hidden bg-[url('/faith.jpeg')] bg-cover bg-center">

//         {/* Dark overlay */}
//         <div className=" bg-black/30"></div>

//         {/* Content */}
//         <div className="relative top-10 text-left flex flex-col items-center px-6 sm:px-10 lg:px-20 max-w-5xl">
    ...
    <>
      <section className="min-h-screen flex items-center overflow-hidden bg-[url('/faith.jpeg')] bg-cover bg-center">
        ...
        <div className="relative top-10 text-left flex flex-col items-center px-6 sm:px-10 lg:px-20 max-w-5xl">
          ...
          ">
            A place to <br />
            <span className="text-yellow-300">belong.</span>
            <br />
            <span className="italic">
              A faith to Live
            </span>
      ...
      <div className="flex text-white gap-50 justify-around items-center bg-orange-400 w-full p-9">
        ...
        <div className="text-white flex flex-col gap-2">
          ...
          <b className="text-2xl">Come as you are</b>
        </div>
